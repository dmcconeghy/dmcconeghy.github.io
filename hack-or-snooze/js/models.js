...
class StoryList {
  ...
  async addStory(user, { title, author, url }) {
    //grab the user's loginToken
    const token = user.loginToken;
    
    // make the API POST
    //POST the story data using the user's loginToken
    ...
    //create the story with the data we POSTed
    // Add the story to the beginning of the stories array
    // Add the story to the beginning of the user's stories array
